...
// funksjon for produksjon av SVO-setning
const konstaterendeSetning = sub + ' ' + ver + ' ' + obj;

// funksjon for produksjon av VSO-setning
const sporresetning = ver + ' ' + sub + ' ' + obj + '?';

// funksjon for produksjon av AVSO-setning
const utsagnssetning = vrbl + ' ' + ver + ' ' + sub + ' ' + obj;

setningsArr = [konstaterendeSetning, sporresetning, utsagnssetning];

const velgSetningstype = () => {
    randI = Math.floor(Math.random() * setningsArr.length)
    return setningsArr[randI]
}
